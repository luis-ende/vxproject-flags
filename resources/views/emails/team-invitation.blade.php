...
¡Has sido invitado a unirte a la comunidad de suscriptores de VX Project Field!
...
Para registrarte y aceptar la invitación haz clic en el siguiente botón:

@component('mail::button', ['url' => route('register') . '?id=' . $invitation->id])
{{ __('Create Account') }}
@endcomponent
